...
export default function DesktopProduct({ product, relatedProducts }) {
  ...
  return (
    <div className="apila" style={{ paddingTop: '72px' }}>
      ...
      <header>
        <nav className={`navbar scrolled`} style={{ height: '72px', padding: '0 48px' }}>
          ...
          <div className="nav-right">
            ...
            <button className="nav-icon-btn" aria-label="Account" onClick={() => setIsLoginOpen(prev => !prev)}>
      ...
      {searchOpen && <DesktopSearchOverlay onClose={() => setSearchOpen(false)} onLoginOpen={() => { setSearchOpen(false); setIsLoginOpen(true); }} />}
