...
const occasions = [
  { slug: 'bridal', title: 'Bridal Set', img: 'http://localhost:5000/uploads/Bridal%20Set.png' },
  { slug: 'bridesmaid', title: 'Bridal Maid', img: 'http://localhost:5000/uploads/Bridal%20Maid.png' },
  { slug: 'designer', title: 'Designer', img: 'http://localhost:5000/uploads/Designer.png', arrow: true },
  { slug: 'reception', title: 'Reception', img: 'http://localhost:5000/uploads/Reception.png', arrow: true },
  { slug: 'party', title: 'Party Wear', img: 'http://localhost:5000/uploads/Party%20Wear.png', arrow: true },
  { slug: 'small', title: 'Small Jewel', img: 'http://localhost:5000/uploads/Small%20Jewel.png', arrow: true },
];
  ...
  return (
    <div className="pb-28 bg-white">
        ...
        <div className="md:hidden grid grid-cols-2 gap-3">
          ...
          <div className="flex flex-col gap-2">
            <Link to="/shop?occasion=bridal" className="relative h-44 rounded-[2rem] overflow-hidden group">
              <img src="http://localhost:5000/uploads/Bridal%20Set.png" alt="Bridal Set"
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
            ...
            <Link to="/shop?occasion=designer" className="relative h-36 rounded-[2rem] overflow-hidden group">
              <img src="http://localhost:5000/uploads/Designer.png" alt="Designer"
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent" />
              <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between text-white">
                <div>
            ...
            <Link to="/shop?occasion=party" className="relative h-44 rounded-[2rem] overflow-hidden group">
              <img src="http://localhost:5000/uploads/Party%20Wear.png" alt="Party Wear"
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent" />
              <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between text-white">
                <div>
          ...
          <div className="flex flex-col gap-2">
            <Link to="/shop?occasion=bridesmaid" className="relative h-36 rounded-[2rem] overflow-hidden group">
              <img src="http://localhost:5000/uploads/Bridal%20Maid.png" alt="Bridal Maid"
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent" />
              <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between text-white">
                <div>
            ...
            <Link to="/shop?occasion=reception" className="relative h-52 rounded-[2rem] overflow-hidden group">
              <img src="http://localhost:5000/uploads/Reception.png" alt="Reception"
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent" />
              <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between text-white">
                <div>
            ...
            <Link to="/shop?occasion=small" className="relative h-36 rounded-[2rem] overflow-hidden group">
              <img src="http://localhost:5000/uploads/Small%20Jewel.png" alt="Small Jewel"
                className="absolute inset-0 w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent" />
              <div className="absolute bottom-5 left-5 right-5 flex items-end justify-between text-white">
                <div>
      ...
      <section className="bg-[#FCF8F5] mt-10 pt-5 pb-4 text-center border-b border-[#EAEAEA]">
        ...
        <button
          onClick={() => window.open('http://localhost:5000/uploads/Rental%20&%20Delivery%20Guide.pdf', '_blank')}
